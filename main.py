...
RED_SPACESHIP = pygame.transform.rotate(RED_SPACESHIP_SCALE, 270)

SPACE = pygame.image.load(os.path.join("Assets", "space.png"))
SPACE_SCALE = pygame.transform.scale(SPACE, (WIDTH, HEIGHT))


def draw_window(red, yellow, red_bullets, yellow_bullets, red_health, yellow_health):
    WIN.blit(SPACE_SCALE, (0, 0))
...
def main():
    red = pygame.Rect(WIDTH-100-SPACESHIP_HEIGHT, HEIGHT //
                      2, SPACESHIP_HEIGHT, SPACESHIP_WIDTH)
    yellow = pygame.Rect(100, HEIGHT //
                         2, SPACESHIP_HEIGHT, SPACESHIP_WIDTH)
